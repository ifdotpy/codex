...
pub struct ThreadStartParams {
    ...
    /// @deprecated Use Ultra reasoning effort for proactive multi-agent behavior.
    ///
...
pub struct ThreadStartResponse {
    ...
    /// @deprecated Use `reasoningEffort` for Ultra behavior.
    #[deprecated(note = "use reasoning_effort for Ultra behavior")]
    #[experimental("thread/start.multiAgentMode")]
    #[serde(default)]
...
pub struct ThreadSettingsUpdateParams {
    ...
    /// @deprecated Use `effort: "ultra"` for proactive multi-agent behavior.
    #[deprecated(note = "use effort=ultra for proactive multi-agent behavior")]
...
pub struct ThreadSettings {
    ...
    /// @deprecated Use `effort` for Ultra behavior.
    #[deprecated(note = "use effort for Ultra behavior")]
